...
/***/ function(module, exports, __webpack_require__) {
	...
	var object = __webpack_require__(73);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _socketIoClient = __webpack_require__(47);
	
	var _socketIoClient2 = _interopRequireDefault(_socketIoClient);
	
	__webpack_require__(16);
	
	_angular2['default'].module('pixelnukeApp').factory('socket', function (socketFactory) {
	  var ioSocket = (0, _socketIoClient2['default'])('', {
	  ...
	  return {
	    ...
	    syncUpdates: function syncUpdates(modelName, array, cb) {
	      ...
	      var localCallback = cb || _angular2['default'].noop;
	
	      socket.on(modelName + ':save', function (item) {
	        localEvent = 'created';
	
	        var oldItem = _lodash2['default'].find(array, { _id: item._id });
	      ...
	      socket.on(modelName + ':remove', function (item) {
	        ...
	        _lodash2['default'].remove(array, { _id: item._id });
...
/***/ function(module, exports, __webpack_require__) {
	...
	_angular2['default'].module('pixelnukeApp').controller('MainCtrl', function ($http, $scope, socket) {
	  $scope.awesomeThings = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _angular2['default'].module('main', [__webpack_require__(44).name]);
